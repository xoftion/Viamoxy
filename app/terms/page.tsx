      ...
      <main className="container py-8 max-w-4xl">
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            ...
            <p>
              STABOOST provides social media marketing services including but not limited to followers, likes, views,
              and engagement services for various social media platforms. We act as a reseller and intermediary between
            ...
            <p>
              ...
              deliver. Partial refunds may be issued for partially completed orders. No refunds are provided for
              completed orders.
            </p>
            ...
            <h3>8. Privacy</h3>
            <p>
              We respect your privacy and protect your personal information. We do not share your data with third
